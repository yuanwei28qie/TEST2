...
public class MrcardFinanceSettlement implements Serializable {
    private Long id;
    @ApiModelProperty("结转账单单号")
    private String settlementsn;
    @ApiModelProperty("客户财务id")
    private Long financeId;
    @ApiModelProperty("账期结转开始时间")
    private Integer accountPeriodBegin;
    @ApiModelProperty("周期结转结束时间")
    private Integer accountPeriodEnd;
    //商品垫付金额
    @ApiModelProperty("商品垫付金额")
    private BigDecimal advanceAmount;
    //运费结算金额
    @ApiModelProperty("运费结算金额")
    private BigDecimal dispatchAmount;
    //小费结算金额
    @ApiModelProperty("小费结算金额")
    private BigDecimal tipAmount;
    //平台抽成金额
    @ApiModelProperty("平台抽成金额")
    private BigDecimal pumpingAmount;
    //结算总金额(运费+小费-抽层)
    @ApiModelProperty("结算总金额(运费+小费-抽层)")
