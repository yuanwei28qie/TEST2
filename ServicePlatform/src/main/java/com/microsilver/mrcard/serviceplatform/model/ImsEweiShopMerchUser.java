...
public class ImsEweiShopMerchUser implements Serializable {
	...
	public String toString() {
		return "ImsEweiShopMerchUser [id=" + id + ", uniacid=" + uniacid + ", regid=" + regid + ", openid=" + openid
				...
				+ ", payrate=" + payrate + ", isrecommand=" + isrecommand + ", servicestag=" + servicestag
				+ ", listTags=" + listTags + ", cateid=" + cateid + ", address=" + address + ", tel=" + tel + ", lat="
				+ lat + ", lng=" + lng + ", isPay=" + isPay + ", isShop=" + isShop + ", code=" + code + ", isMill="
				+ isMill + ", lv2=" + lv2 + ", province=" + province + ", city=" + city + ", county=" + county
				+ ", sendSms=" + sendSms + ", pic1=" + pic1 + ", pic2=" + pic2 + ", publicitypic=" + publicitypic
				+ ", idNo=" + idNo + ", referee=" + referee + ", shopType=" + shopType + ", pantnrType=" + pantnrType
				+ ", userId=" + userId + ", score=" + score + ", counts=" + counts + ", starLevel=" + starLevel
				+ ", supportBiaoshi=" + supportBiaoshi + ", supportPickUp=" + supportPickUp + ", comment=" + comment
				+ ", beginTime=" + beginTime + ", endTime=" + endTime + ", lowestPrice=" + lowestPrice + ", distance="
				+ distance + ", cashbackMax=" + cashbackMax + ", activity=" + activity + ", sortWeight=" + sortWeight
				+ ", engMerchname=" + engMerchname + ", tradingArea=" + tradingArea + ", merchType=" + merchType + "]";
	}
}