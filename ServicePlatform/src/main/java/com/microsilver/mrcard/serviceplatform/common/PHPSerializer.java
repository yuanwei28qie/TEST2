    ...
    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) {  
      ...
      public static void main(String[] args) throws IllegalAccessException, UnsupportedEncodingException {
    	  List<String> list = new ArrayList<String>(){
    		  {
    			  this.add("hgjsdo/j个k.jpg");
    			  this.add("fg57do/jqj是吗hk.jpg");
    			  this.add("jk好j/s645k.jpg");
    		  }
    	  };
    	  System.out.println(new String(serialize(list,"utf-8"),"utf-8")); 
    	  String s = "a:3:{i:0;s:13:\"hgjsdo/jk.jpg\";i:1;s:16:\"fg57do/jqjhk.jpg\";i:2;s:13:\"jkj/s645k.jpg\";}";
    	  System.out.println(unserialize(s.getBytes()));
    	  System.out.println(Utils.unserializePHParray(s));
	}
} 
