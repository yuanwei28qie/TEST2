...
//		System.out.println(result);
	...
	public static void sendMsg(String mobile,String checkCode) {
		...
		params.put("content", "您的验证码是"+checkCode+"，如非本人操作，请忽略本短信。");
		String result=HttpTookit.sendPost(url, params);
		System.out.println(result);
	}
